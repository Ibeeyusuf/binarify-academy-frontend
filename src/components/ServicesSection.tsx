      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            Why Binarify Academy
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We bridge the gap between education and employment. Our programs combine essential life skills, practical technical training, and guided industry experience so you can land real roles and grow fast.
          </p>
        </motion.div>
