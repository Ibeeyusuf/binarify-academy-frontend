      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            Listen to Parents' Feedback
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Hear from families who have transformed their children's education with our platform.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <Card className="p-8 border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 bg-gradient-to-br from-white to-blue-50 h-full">
                <motion.div 
